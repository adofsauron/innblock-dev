...
void aligned_free(void *palignedmem) { free(reinterpret_cast<void *>((static_cast<void **>(palignedmem))[-1])); }
...
int16_t mach_read_from_2_16(const byte *b) { return (((int16_t)(b[0]) << 8) | (ulint)(b[1])); }
